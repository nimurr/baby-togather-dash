...
const Subscription = () => {
    ...
    const showModal = (edit = false, subscription = {}) => {
        ...
        if (edit) {
            ...
            setMonthlyType(subscription.type === 'weekly' ? '1' : subscription.type === 'monthly' ? '2' : '3');
            setPrice(subscription.amount);
            setFeatures(subscription.features || []); // Pre-fill the features array
    ...
    const handleSubmit = async (e) => {
        ...
        const formData = {
            ...
            type: monthlyType === '1' ? 'weekly' : monthlyType === '2' ? 'monthly' : 'yearly',
        };
